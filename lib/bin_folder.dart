...
//   final appModel = GetIt.instance<AppModel>();

//   @override
//   void initState() {
//     super.initState();
//     appModel.addListener(update);  // Listen to changes in the model
//   }

//   @override
//   void dispose() {
//     appModel.removeListener(update); // Clean up listener
//     super.dispose();
//   }
...
//       ),
//       floatingActionButton: FloatingActionButton(
//         onPressed: appModel.incrementCounter,
//         tooltip: 'Increment',
//         child: const Icon(Icons.add),
//       ),
//     );
